...
ExSim workers demand salary increases that AT MINIMUM keep pace with inflation.
Failure to meet this expectation triggers STRIKE RISK.
...
TIP: Aim for 1-2% ABOVE inflation for motivation. The extra cost prevents
     production disruptions from strikes, which are far more expensive.
